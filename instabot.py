...
APP_ACCESS_TOKEN = '1564656964.9430a75.5b53023060744fcb81e63037b0a91aa5'
...
'''
   A user's interests based on hashtag analysis of recent posts and plot the same using matplotlib.
'''
...
def start_bot():
    while True:
        ...
        print "j.User's interests based on hashtag \n"
        print "k.Exit"
